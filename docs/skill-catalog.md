...
| 防御 | `ability:defense` | 同态复仇 `retaliatory_flame`、准备万全 `well_prepared`、求生技巧（待确认）`survival_skills`、生还者 `survivor` |
| 建造 | `ability:building` | 紫颂果嬗变术 `chorus_transmutation`、威亚 `ceiling_wire`、环球旅行者/铁砧修补（待确认）`world_traveler` |
| 农耕 | `ability:farming` | 精力充沛 `energetic`、俭省（待确认）`frugality`、收割 `harvest` |
...
1. 防御页第三项在技能页未命名，“其他说明”中为“求生技巧”。
2. 农耕页第二项在技能页未命名，“其他说明”中为“俭省”。
3. 建造页“环球旅行者”与“其他说明”的“铁砧修补”可能不是同一技能。
4. 魔法页“压碎”与“其他说明”的“重锤”命名不一致。
5. “突破”未列入“其他说明”的汇总表。
